    ...
    <>
      ...
      <div className="w-full px-4 md:px-10 py-6 md:py-10 max-w-[1280px] mx-auto">
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl flex flex-col gap-6 md:gap-8">
            <div className="flex flex-col gap-3">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent-lime text-xs font-bold uppercase tracking-wider text-text-main w-fit">
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                to="/formulario"
                className="bg-primary hover:bg-primary-dark text-text-main font-bold text-base px-8 py-4 rounded-xl shadow-lg transition-all hover:translate-y-[-2px]"
              >
                Solicitar Información
              </Link>
              <Link 
                to="/ubicacion"
                className="bg-white hover:bg-gray-50 text-text-main font-bold text-base px-8 py-4 rounded-xl shadow-lg transition-all hover:translate-y-[-2px] flex items-center gap-2"
              >
      ...
      <div className="w-full px-4 md:px-10 py-16 max-w-[1280px] mx-auto">
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          <div className="order-2 md:order-1 relative">
            ...
            <div className="absolute -left-10 -top-10 w-full h-full bg-accent-lime/30 rounded-[3rem] -rotate-3 z-0"></div>
            <img 
            ...
            />
            {/* Floating badge */}
            <div className="absolute -bottom-6 -right-6 z-20 bg-white p-4 rounded-2xl shadow-soft flex items-center gap-3 animate-bounce" style={{ animationDuration: '3s' }}>
        ...
        <div className="w-full px-4 md:px-10 max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-background-light p-8 rounded-2xl border border-transparent hover:border-primary/20 hover:shadow-soft transition-all group">
                <div className="size-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-primary mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
      ...
      <div className="w-full px-4 md:px-10 py-20 max-w-[1280px] mx-auto" id="propuesta">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          {[
            { icon: 'handshake', color: 'blue', title: 'Respeto', desc: 'Valoramos el ritmo individual y las emociones de cada niño.' },
            { icon: 'security', color: 'green', title: 'Seguridad', desc: 'Ambiente físico y emocional protegido para la exploración.' },
            { icon: 'favorite', color: 'red', title: 'Salud', desc: 'Promoción de hábitos saludables y bienestar físico.' },
            { icon: 'accessibility_new', color: 'orange', title: 'Autonomía', desc: 'Fomentamos la independencia en actividades cotidianas.' },
            { icon: 'directions_run', color: 'purple', title: 'Movimiento', desc: 'El aprendizaje entra por el cuerpo y la experiencia activa.' },
            { icon: 'forum', color: 'teal', title: 'Comunicación', desc: 'Diversos lenguajes expresivos para manifestar el mundo interior.' },
            { icon: 'toys', color: 'yellow', title: 'Juego Libre', desc: 'La herramienta más seria y poderosa de aprendizaje infantil.' },
          ].map((principle, index) => (
            <div key={index} className="flex-1 min-w-[280px] md:max-w-[300px] bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
              <div className={`size-10 rounded-full bg-${principle.color}-100 text-${principle.color}-600 flex items-center justify-center mb-4`}>
      ...
      <div className="w-full px-4 md:px-10 py-10 max-w-[1280px] mx-auto" id="talleres">
        <div className="bg-[#12201e] rounded-3xl p-8 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="relative z-10 w-full md:w-auto flex justify-center">
            <div className="relative size-60 md:size-80 bg-primary rounded-full flex items-center justify-center overflow-hidden border-8 border-white/5">
              <img 
              ...
              />
              <span className="material-symbols-outlined text-white text-[80px] absolute drop-shadow-lg">sports_gymnastics</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white py-20 mt-10" id="admision">
        <div className="w-full px-4 md:px-10 max-w-[1280px] mx-auto">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center text-center relative">
                  <div className={`size-12 ${step.color} rounded-full flex items-center justify-center font-bold text-xl mb-4 border-4 border-white shadow-sm z-10`}>
          ...
          <div className="text-center mt-12">
            <Link 
              to="/admision"
              className="inline-flex items-center gap-2 bg-primary hover:bg-primary-dark text-text-main font-bold px-8 py-4 rounded-xl transition-all"
            >
      ...
      <div className="w-full px-4 md:px-10 py-20 max-w-[1280px] mx-auto">
        <div className="bg-accent-lime/20 rounded-[2rem] p-8 md:p-16 text-center relative">
          <span className="material-symbols-outlined text-6xl text-primary/30 absolute top-8 left-8">format_quote</span>
          <p className="text-2xl md:text-3xl font-bold text-text-main leading-snug max-w-4xl mx-auto relative z-10">
          ...
          <div className="mt-8 flex flex-col items-center">
            <div className="size-16 rounded-full overflow-hidden mb-3 border-2 border-white shadow-sm">
              <img 
