          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="size-10 rounded-full bg-gray-100 flex items-center justify-center text-text-main hover:bg-[#25D366] hover:text-white transition-colors"
              >
                <svg className="size-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-3 flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3 text-text-muted">
                ...
                <span>Calle Morropon 105,<br/>Santiago de Surco, Lima</span>
              </li>
              <li className="flex items-center gap-3 text-text-muted">
                <span className="material-symbols-outlined text-primary">call</span>
                <a href="tel:+51908880326" className="hover:text-primary transition-colors">+51 908 880 326</a>
              </li>
              <li className="flex items-center gap-3 text-text-muted">
                <span className="material-symbols-outlined text-primary">mail</span>
                <a href="mailto:lacasitademamisurco@gmail.com" className="hover:text-primary transition-colors">lacasitademamisurco@gmail.com</a>
              </li>
            </ul>
          </div>
